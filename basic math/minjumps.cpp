//is array is 1,0,0,5 then you cant reach end of array 
//how to take of zeros in between?
//whenever prob soln youve come up with is try all possible ways(brute force), use recursion
